      ...
      <div className={cx('container')}>
        ...
        <div className={cx('description')}>
          ...
          <div className={cx('des-item')}>
            ...
            <span className={cx('value')}>{commas(total * user?.rank?.discountRate / 100 + '')} VND</span>
          </div>
          <div className={cx('des-item')}>
            {fee ? (
              <>
                <span className={cx('label')}>Delivery Fee</span>
                <span className={cx('value')}>{commas(fee + '')} VND</span>
              </>
            ) : (
              <></>
            )}
        ...
        <div className={cx('total')}>
          ...
          <span className={cx('value')}>{commas(total * (1 + user?.rank?.discountRate / 100) + fee + '')} VND</span>
        </div>
      </div>
    </div>
  );
